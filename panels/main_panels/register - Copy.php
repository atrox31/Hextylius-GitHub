<div id='panel_rejestracji' style='color: black; text-align: center;'>
	...
	<input type='submit' value='Rejestracja' class='input' id='guzik' onClick="post('{$GLOBALS['SUBDOMEN']}.index.php?ekran={$_GET['ekran']}', {register: 'register', username: $('#username').val(), email: $('#email').val(), password: $('#password').val(), repassword: $('#repassword').val(), terms: $('#terms').prop('checked')})">
